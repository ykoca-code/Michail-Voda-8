# Michail Voda 8 — Golden Visa Pazarlama Planı

**Proje:** 8 Michail Voda Sok., Atina (ofis binasının konuta dönüşümü — Gavalas·Ioannidou Architecture)
**Hedef:** Kalan daireleri Türkiye'deki Golden Visa yatırımcılarına satmak; vize sürecini uçtan uca kendi hizmetimiz olarak paketlemek.
**Tarih:** Ağustos 2026
...
Pazarlamanın tamamı şu mevzuat gerçeğinin üzerine kurulmalı:

| Kural | Durum | MV8 için anlamı |
|---|---|---|
...
## 3. Konumlandırma ve mesaj mimarisi

**Tek cümlelik konumlandırma:** *"Atina'nın merkezinde sıfır daire + tüm aile için 5 yıllık oturum izni + 5 yıl kira garantisi — tek pakette, tek muhataptan."*
...
**Hedef kitle (persona):**
- 35–60 yaş, Türkiye büyükşehirleri (İstanbul, Ankara, İzmir, Bursa, Antalya) + yurtdışındaki Türk pasaportlular (Almanya, Hollanda, İngiltere, Körfez).
- Profil: işletme sahibi, üst düzey yönetici, doktor/avukat, gayrimenkul yatırımcısı; çocuklarının Avrupa'da eğitim/yaşam opsiyonu ve "B planı" arayanlar; döviz varlığını yurtdışı gayrimenkule park etmek isteyenler.
- Tetikleyiciler: Schengen vize randevu krizleri, TL riski, çocukların üniversite planı, emeklilik planı.

## 4. Instagram

**Kullanıcı adı:** `@michailvoda8` (yedekler: `@mv8athens`, `@michailvoda8athens`). Profil adı: **Michail Voda 8, Athens** (aramada "golden visa" yakalansın diye ad alanı: "Michail Voda 8 | Atina Golden Visa").

**Bio (TR ağırlıklı, EN destekli):**
> 🏛 Atina merkezde sıfır daireler — 250.000 €
> 🇬🇷 Ticari→konut dönüşüm istisnasıyla Golden Visa
> 👨‍👩‍👧‍👦 Tüm aile için 5 yıllık oturum • 5 yıl kira garantisi
> ↓ Bilgi paketi + fiyat listesi

Link: Linktree yerine kendi sitemizde `/basvuru` sayfası (UTM'li). WhatsApp Business linki bio'da ayrıca dursun.

**İçerik sütunları (haftalık ritim):**
1. **Şantiye/dönüşüm günlüğü** (Reels, haftada 1): ofisten konuta dönüşümün öncesi/sonrası — moodboard'daki kiremit kırmızısı cephe, cam tuğla, meşe detaylar. Dönüşüm hikâyesi aynı zamanda 250k istisnasının görsel kanıtı.
2. **Daire turları** (Reels + carousel, haftada 1): kat planı + render + m²; her boş daireye bir yayın. "101 numaralı daire" gibi envanter dili kıtlık algısı yaratır; satılanlara "SATILDI" etiketi.
3. **Süreç eğitimi** (carousel, haftada 1): "800k vs 250k eşiği", "Golden Visa'da aile kimleri kapsar", "Vekaletname + apostil adım adım", "Kısa dönem kiralama yasağı ve bizim kira modelimiz". Hukuk içeriklerini avukat onayından geçir.
4. **Atina yaşamı / konum** (haftada 1): Victoria bölgesi, Ulusal Arkeoloji Müzesi, Areos Parkı, tren garı, Kolonaki'ye/Syntagma'ya mesafe; "İstanbul'a 1 saat uçuş".
5. **Sosyal kanıt** (2 haftada 1): teslim/tapu anları (yüz izniyle), "18/30 satıldı" sayaç görselleri, ekip + avukatlık bürosuyla ofis karesi.

**Highlight'lar:** Daireler · Süreç · Fiyat & Masraflar · SSS · Atina · Satılanlar.

**Dil:** Ana dil Türkçe, her gönderiye kısa İngilizce özet paragraf. İlk 30 gün, yukarıdaki 5 sütundan haftada 4 gönderi + her gün 2–3 story (şantiye, SSS cevabı, basından Golden Visa haberi).

**DM otomasyonu:** ManyChat vb. ile "FİYAT" yazana otomatik PDF broşür + WhatsApp yönlendirme. Yorum tetikleyicili ("bilgi" yazana DM) Reels kampanyaları CPL'i belirgin düşürür.

## 5. Web sitesi

**Domain önerileri:** `michailvoda8.com` (marka) — yedek: `mv8athens.com`. TR SEO için site içi içerik Türkçe; `/en` İngilizce.

**Yapı (tek uzun sayfa + 3 alt sayfa):**
1. **Ana sayfa:** Hero (bina cephesi render + "Atina'da 250.000 €'ya sıfır daire ve ailenize 5 yıllık oturum") → sayı hikâyesi tablosu → neden 250k mümkün (dönüşüm istisnası, kısa mevzuat kutusu) → daire envanteri (kat planlı kartlar, SATILDI rozetleri) → 5 yıllık kira garantisi → süreç zaman çizelgesi (vekaletname→tapu→biyometri→kart) → ekip & avukat bürosu → SSS → form.
2. **/daireler:** filtrelenebilir envanter, her daire için plan + m² + durum.
3. **/surec:** hukuk bürosunun bilgilendirme dokümanının web hâli (adım adım, belge listesi).
4. **/basvuru:** kısa form — ad, telefon (WhatsApp), e-posta, "yatırım zamanlaması" (0–3 ay / 3–6 ay / araştırıyorum), aile büyüklüğü. KVKK açık rıza kutusu.

**Teknik:** Hız ve düşük bakım için Framer/Webflow veya bu repo üzerinden statik site (Next.js/Astro) + form → CRM webhook. WhatsApp floating button, TR/EN dil değiştirici, Meta Pixel + CAPI, GA4, Google Tag Manager. Tüm reklam trafiği UTM'li.

**SEO ana kelimeler:** "yunanistan golden visa", "yunanistan oturum izni gayrimenkul", "atina 250.000 euro golden visa", "yunanistan golden visa şartları 2026", "atina daire yatırım". Her biri için blog/SSS içeriği.

## 6. Reklam kurulumu

**Meta (Instagram + Facebook) — bütçenin ~%75'i.**
...
**Google — bütçenin ~%25'i.** Arama kampanyası: "yunanistan golden visa" (ve varyantları), "yunanistan oturum izni", "atina emlak yatırım". Bu kelimelerde arama niyeti çok yüksek, hacim düşük-orta, TBM 1–3 €. Marka kampanyası (`michail voda 8`) ucuz koruma. Opsiyonel: YouTube in-stream (TOFU videosunun 20 sn'lik hâli).

**Bütçe ve funnel matematiği (hedef: 12 dairenin 9–12'sini 6 ayda satmak):**

| Metrik | Varsayım |
|---|---|
| Aylık reklam bütçesi | 3.000–5.000 € (ilk ay 3.000 € test) |
| Hedef CPL (Meta instant form) | 5–15 € |
| Aylık lead | 250–500 |
| Lead → nitelikli (bütçe uygun) | %10–15 |
| Nitelikli → Zoom sunum | %50 |
| Zoom → Atina gezisi / rezervasyon | %20–25 |
| Sonuç | ayda ~1,5–3 satış |

İlk 2 haftada CPL ve nitelik oranına göre bütçe yeniden dağıtılır; işleyen tek metrik **daire başı pazarlama maliyeti** (hedef: satış başına ≤2.500 €).

**Örnek reklam metinleri (test için 3 açı):**
1. *Eşik açısı:* "Atina'da Golden Visa eşiği 800.000 €'ya çıktı. Bu binada hâlâ 250.000 €. Çünkü Michail Voda 8, yasadaki ticariden-konuta dönüşüm istisnası kapsamında. 30 dairenin 18'i satıldı. Bilgi paketi için formu doldurun."
...
**Araçlar:** WhatsApp Business API + basit CRM (HubSpot Starter veya Pipedrive). Lead kaynağı/UTM CRM'e otomatik düşsün. SLA: her lead'e aynı gün temas, 3 temaslık takip dizisi (1. gün, 3. gün, 7. gün), ölü lead'lere ayda 1 e-bülten (şantiye ilerlemesi + kalan daire sayısı).

**Satış kiti (hazırlanacak):** TR fiyat/masraf tek sayfalık PDF, mimari sunumun pazarlama versiyonu (mevcut 445 sayfalık FP dosyasından 20 sayfalık seçki), süreç zaman çizelgesi PDF (hukuk bürosu dokümanından), Zoom sunum destesi, sözleşme örnekleri.

## 8. Hukuk ve uyum (kritik)
...
**Hafta 1–2 — Altyapı:**
- [ ] Domain + Google Workspace e-posta, Instagram + Facebook sayfası, Meta Business Manager, WhatsApp Business API
- [ ] Marka mini-kiti (moodboard'daki kiremit kırmızısı + meşe paleti, logo/tipografi)
- [ ] Fiyat PDF'i, 20 sayfalık sunum seçkisi, süreç PDF'i
- [ ] Kira garantisi sözleşme şablonu + reklam dili avukat onayı

**Hafta 3–4 — Yayın:**
- [ ] Web sitesi canlı (Pixel + CAPI + GA4 + CRM entegrasyonu test edilmiş)
- [ ] Instagram'da ilk 9 gönderi (grid dolu görünsün) + highlight'lar
- [ ] TOFU videosu çekim/kurgu (şantiyeden gerçek görüntü + render mix)

**Hafta 5–8 — Reklam testi:**
- [ ] Meta: 3 metin açısı × 2 format (Reels/carousel) × instant form vs site formu testi, 3.000 €
- [ ] Google Search canlı
- [ ] İlk Zoom sunumları; funnel oranlarını CRM'de ölç

**Hafta 9–12 — Ölçekleme:**
- [ ] Kazanan kreatif/hedefleme kombinasyonuna bütçeyi kaydır (5.000 €/ay)
- [ ] Lookalike kitleler, retargeting derinleştirme
- [ ] İlk Atina yatırım turu organizasyonu; teslim/tapu içerikleriyle sosyal kanıt döngüsü
- [ ] KPI incelemesi: CPL, nitelikli lead oranı, satış başı maliyet, satılan daire sayısı

**KPI panosu (haftalık):** harcama · lead · CPL · nitelikli lead · Zoom sayısı · rezervasyon · satış · kalan envanter.

## 10. Kaynaklar

- [Global Citizen Solutions — Greece Golden Visa New Rules 2026](https://www.globalcitizensolutions.com/greece-golden-visa-new-rules/)
- [Varnavas Law — Greek Golden Visa 2.0: New Rules, 2026 Legal Guide](https://varnavas.gr/newsroom/post/new-rules-golden-visa-greece-2024/)
- [OULANG — €250K Commercial-to-Residential Conversion (2026)](https://oulang.com/en/invest/250k-eur-commercial-to-residential)
- [RS Greece — Golden Visa 2026: Investments from €250,000, Conversion Projects in Athens](https://rs-greece.com/golden-visa-greece-2026-investments-from-e250000-and-new-conversion-projects-in-athens/)
- [InvestmentVisa — Renting a Greece Golden Visa Property: 2026 Rules](https://www.investmentvisa.com/news-and-media/renting-greece-golden-visa-property)
